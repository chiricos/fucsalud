...
EOT;
        ...
        switch($gtranslate_look) {
            case 'flags_dropdown': {
                ...
                $block_content .= '<br><select onchange="doGTranslate(this);" aria-label="doGTranslate(this);">';
            ...
            case 'dropdown': {
                $block_content .= '<select onchange="doGTranslate(this);" aria-label="doGTranslate(this);">';
                $block_content .= '<option value="">Select Language</option>';
