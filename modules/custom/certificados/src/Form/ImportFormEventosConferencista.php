...
class ImportFormEventosConferencista extends FormBase {
	/**
	 * {@inheritdoc}
	 */
	public function getFormId() {
		return 'certificados_form_eventos_conferencista';
	}
	/**
	 * {@inheritdoc}
	 */
	...
	public function submitForm(array &$form, FormStateInterface $form_state) {
		...
		foreach($data as $row) {
			$conteo++;
			$result = $connection->insert('certificado_eventos_conferencista')
				->fields([
